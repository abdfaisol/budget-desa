                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                <form class="card-body uppercase" method="post" action="/alokasi/update" enctype="multipart/form-data">
                                    @csrf
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <select id="inputState" name="tipe" class="form-control">
                                      ...
                                      <option value="{{ $data->idjenis }}" <?= ($data->jenisAnggaran == $data1->jenis)? 'selected': ''; ?>>{{ $data->jenisAnggaran }}</option>
                                      @endforeach
                                    </select>
                                  </div>
                              </div>
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <select id="inputState" name="sumber" class="form-control">
                                      ...
                                      <option value="{{ $data->idsumber }}" <?= ($data->name == $data1->sumber)? 'selected': ''; ?>>{{ $data->name }}</option>
                                      @endforeach
                                    </select>
                                  </div>
                              </div>
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                     <select id="inputState" name="kelompok" class="form-control">
                                      ...
                                      <option <?= ($data->kelompok == $data1->kelompok)? 'selected': ''; ?> value="{{ $data->idkelompok }}">{{ $data->kelompok }}</option>
                                      @endforeach
                                    </select>
                                  </div>
                              </div>
                              ...
                              <div class="form-group row">
                                    ...
                                    <textarea name='detail' class="form-control" id="exampleFormControlTextarea1" rows="3" maxlength="255">{{ $data1->deskripsi }}</textarea>

                              </div>
                              <button type="submit" class="btn btn-primary">Update Data</button>
                              <input type="hidden" name="idalokasi" value="{{ $data1->idalokasi }}">
                          </form>
                            </div>
                        </div>
                    </div>
