...
<!-- Begin Page Content -->
                <div class="container">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-center mb-4">
                        <h1 class="h1 mb-0 font-weight-bold text-gray-800 text" style="margin: 2rem">E-Budget Desa</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Data Publik Alokasi</h6>
                            </div>
                            <div class="card-body">
