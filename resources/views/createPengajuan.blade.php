                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                <form class="card-body uppercase" method="post" action="insert" enctype="multipart/form-data">
                                    ...
                                    <label for="staticEmail" class="col-sm-2 col-form-label">Diajukan Ke</label>

                                    <div class="col-sm-10">
                                     <select id="inputState" class="form-control" name="sendto">
                                      @foreach ($sendto as $main)
                                      <option value="{{ $main->idmikro }}">{{ $main->mikro }}</option>
                                      @endforeach
                                    </select>
                                  </div>
                              </div>
                                  ...
                                  <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label">Pengajuan</label>
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control @error('nip') is-invalid @enderror" id="" name="judul" placeholder="Contoh : 990xxx"
                                      value="" 
                                      >
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control @error('nip') is-invalid @enderror" id="" name="pj" placeholder="Contoh : 990xxx"
                                      value="" 
                                      >
                                      <div class="invalid-feedback">
                                        @error('pj') 
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control @error('nip') is-invalid @enderror" id="" name="rekening" placeholder="Contoh : 990xxx"
                                      value="" 
                                      >
                                      <div class="invalid-feedback">
                                        @error('rekening') 
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="number" class="form-control @error('nip') is-invalid @enderror" id="" name="dana" placeholder="Contoh : 990xxx"
                                      value="" 
                                      >
                                      <div class="invalid-feedback">
                                        @error('dana') 
