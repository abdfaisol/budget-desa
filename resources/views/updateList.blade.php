                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                <form class="card-body uppercase" method="post" action="/list/detail/update" enctype="multipart/form-data">
                                    @csrf
                                  <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-2 col-form-label">Name</label>
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control @error('name') is-invalid @enderror" id="" name="name" placeholder="Contoh : 990xxx"
                                      value="{{ $data->detailAlokasi }}" 
                                      >
                              ...
                              <div class="form-group row">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" maxlength="255">{{ $data->deskripsi }}</textarea>

                              </div>
                              <input type="hidden" name="iddetailAlokasi" value="{{ $data->iddetailAlokasi }}">
